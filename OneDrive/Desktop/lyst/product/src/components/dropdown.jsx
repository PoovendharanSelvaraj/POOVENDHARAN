    ...
    return (
        <div className="dropdown">
         <div className="dropdownbtn" onClick={e=>setIsActive(!isActive)}>
             Gender
            <Link to="/"> <BsChevronDown /></Link>
         </div>
         {isActive && (
             <div className="dropdwonContent">
             <div className="dropdownItems">
             <Link style={{textDecoration:"none",color:"black"}}  to="/women"><p>Women's</p></Link>

             <Link style={{textDecoration:"none",color:"black"}}  to="/men"><p>Men's</p></Link>
             </div>
         </div>
         )}
        </div>
